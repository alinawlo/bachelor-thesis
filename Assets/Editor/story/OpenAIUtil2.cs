...
static class OpenAIUtil2
{
    static string CreateChatRequestBody(string sysContext, string prompt)
    {
        ...
        /**
        It's usually best to provide clear instructions at the beginning of the 
        prompt so that the AI understands what is expected. However, both methods 
        can work depending on the context and desired outcome. 
        In general, it's crucial to provide clear and concise instructions to ensure the AI 
        understands what is expected.

        When using the OpenAI API, it is generally recommended to provide the 
        instruction within the user input. This way, the instruction is more 
        closely tied to the user's question or prompt, allowing the AI to 
        understand the context better.

        Whether to split the instructions or create one message with all instructions depends on the context and the complexity of the instructions. Here are some general guidelines to help you decide:

        1. Split instructions: If the instructions are related to different aspects of the conversation or need to be followed in a specific sequence, it may be helpful to split them into separate messages. This can make it easier for the AI to process and understand each instruction individually.
        2. Combine instructions: If the instructions are closely related or need to be understood as a whole, it may be better to combine them into a single message. This can help the AI grasp the overall context and expectations more effectively.
        **/
        ...
        // req.max_tokens = 1000;
        req.messages = new [] { sysMsg, msg1, msg1_2, msg1_3, msg2, msg3, msg3_2, msg3_3, msg4, msg4_2, msg };
