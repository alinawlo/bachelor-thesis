...
4. Specify the values for the element's  transform position, please keep in mind abiding the laws of gravity (e.g., "Set the Transform Position to (0, 0.1, 0)")
...
d. Set the Transform Position to (0, 0, 0) to place the ball at the center of the scene.
